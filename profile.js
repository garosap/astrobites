            ...
            <View style={styles.topBar}>
                ...
                <View style={{alignItems:'center', paddingTop:hp('2%')}}>
                    ...
                    <View
                        ...
                        <View style={{height:hp('0.1%'), width:wp('93%'), backgroundColor:'#ddd', marginTop:hp('2.5%')}}></View>
                        <View style={{marginTop:hp('2%'),flexDirection:'row',alignSelf:'flex-start',paddingLeft:wp('4%')}}>
                            <Text style={{fontSize:wp('4%'), fontWeight:'bold', color:colors.text}}>Badges</Text>
                        </View>
